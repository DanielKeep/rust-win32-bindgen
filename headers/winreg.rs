...
#[cfg(feature="winapi_desktop")] #[cfg(any(feature="winapi_ver_04000000"))] #[cfg(any(target_arch="x86"))] pub type QUERYHANDLER = extern "C" fn(*mut ::libc::c_void, *mut ::winreg::val_context, ::libc::c_ulong, *mut ::libc::c_void, *mut ::libc::c_ulong, ::libc::c_ulong) -> ::libc::c_ulong; /* winreg.h:149:1 */
#[cfg(feature="winapi_desktop")] #[cfg(any(feature="winapi_ver_04000000"))] #[cfg(any(target_arch="x86"))] pub type PQUERYHANDLER = extern "C" fn(*mut ::libc::c_void, *mut ::winreg::val_context, ::libc::c_ulong, *mut ::libc::c_void, *mut ::libc::c_ulong, ::libc::c_ulong) -> ::libc::c_ulong; /* winreg.h:152:27 */
...
#[cfg(feature="winapi_desktop")] #[cfg(any(feature="winapi_ver_04000000"))] #[cfg(any(target_arch="x86_64", target_arch="arm"))] pub type QUERYHANDLER = extern "system" fn(*mut ::libc::c_void, *mut ::winreg::val_context, ::libc::c_ulong, *mut ::libc::c_void, *mut ::libc::c_ulong, ::libc::c_ulong) -> ::libc::c_ulong; /* winreg.h:149:1, winreg.h:149:1 */
#[cfg(feature="winapi_desktop")] #[cfg(any(feature="winapi_ver_04000000"))] #[cfg(any(target_arch="x86_64", target_arch="arm"))] pub type PQUERYHANDLER = extern "system" fn(*mut ::libc::c_void, *mut ::winreg::val_context, ::libc::c_ulong, *mut ::libc::c_void, *mut ::libc::c_ulong, ::libc::c_ulong) -> ::libc::c_ulong; /* winreg.h:152:27, winreg.h:152:27 */
